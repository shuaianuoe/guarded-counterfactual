...
def load_dataset(
    ...
    # path = "https://raw.githubusercontent.com/carla-recourse/cf-data/master/"
    # added by shuai. When we click the dataset in the github ("raw" button in the rightupper), then the path name will be shown.
    path = "https://raw.githubusercontent.com/shuaianuoe/cf-data/main/{}.csv"
    ...
    # test_path = path.format(name)[:-4] + "_test_bias.csv"  # remove .csv and add new suffix
